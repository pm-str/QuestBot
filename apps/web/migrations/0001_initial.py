# -*- coding: utf-8 -*-
# Generated by Django 1.11.7 on 2017-11-24 15:59
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateField(auto_now_add=True, verbose_name='Created at')),
                ('modified', models.DateField(auto_now=True, verbose_name='Updated at')),
                ('ids_expression', models.CharField(default='{}', max_length=500, verbose_name="Mathematics expression from ids. Allowed '+*()!'")),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('requests', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='responses', to='web.Request', verbose_name='Attached request to')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            model_name='request',
            name='steps',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='requests', to='web.Step'),
        ),
        migrations.AddField(
            model_name='event',
            name='responses',

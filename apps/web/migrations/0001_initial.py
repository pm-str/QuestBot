# -*- coding: utf-8 -*-
# Generated by Django 1.11.7 on 2017-12-23 10:24
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='event',
            name='message',
            field=models.ManyToManyField(blank=True, to='web.Message', verbose_name='Reply to message'),
        ),
        migrations.AddField(
            model_name='event',
            name='response',
